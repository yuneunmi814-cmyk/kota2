...
한국관광공사 × 카카오 2026 관광데이터 활용 공모전 출품작.
**★정식 도메인: ko-ta.co.kr** (라이브 확인 8/25) — ⛔**대외 문서·제출물엔 vercel 주소를 쓰지 말 것.**
(kota2.vercel.app은 같은 배포의 내부 주소다. 주소를 바꾸면 카카오 콘솔의 지도·로그인 도메인 등록도 같이.)
