...
const ko: Dict = {
  ...
  'row.designated': '문화관광축제',
  'row.designated.sub': '문화체육관광부가 지정한 축제',
  'row.more': '모두 보기',
  'detail.about': '소개',
  'detail.food': '먹거리',
  'detail.program': '프로그램',
...
const en: Dict = {
  ...
  'row.designated': 'Designated festivals',
  'row.designated.sub': 'Selected by the Ministry of Culture',
  'row.more': 'See all',
  'detail.about': 'About',
...
const ja: Dict = {
  ...
  'row.designated': '文化観光祭り',
  'row.designated.sub': '文化体育観光部の指定',
  'row.more': 'すべて見る',
  'detail.about': '概要',
  'detail.food': 'グルメ',
...
const th: Dict = {
  ...
  'row.designated': 'เทศกาลที่ได้รับการรับรอง',
  'row.designated.sub': 'คัดเลือกโดยกระทรวงวัฒนธรรม',
  'row.more': 'ดูทั้งหมด',
