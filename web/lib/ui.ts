...
const ko: Dict = {
  ...
  'photo.region': '지역 사진',
  'photo.region.note': '축제 포스터가 아니라 {place}의 풍경 사진이에요. 포스터는 주최측 공지를 확인해 주세요.',
  'photo.region.src': '사진 © 한국관광공사 포토코리아 (공공누리 제1유형)',
  'grade.mf': '문화관광축제',
  'row.ending': '곧 끝나요',
...
const en: Dict = {
  ...
  'photo.region': 'Regional photo',
  'photo.region.note': 'Not the festival poster — a scenic photo of {place}. Check the organizer for the poster.',
  'photo.region.src': 'Photo © Korea Tourism Organization PhotoKorea (KOGL Type 1)',
...
const ja: Dict = {
  ...
  'photo.region': '地域の写真',
  'photo.region.note': '祭りのポスターではなく{place}の風景写真です。ポスターは主催者の告知をご確認ください。',
  'photo.region.src': '写真 © 韓国観光公社 フォトコリア（KOGL第1類型）',
  'grade.mf': '文化観光祭り指定',
  'row.ending': 'まもなく終了',
...
const th: Dict = {
  ...
  'photo.region': 'ภาพประจำท้องถิ่น',
  'photo.region.note': 'ไม่ใช่โปสเตอร์เทศกาล แต่เป็นภาพวิวของ{place} กรุณาตรวจสอบโปสเตอร์จากผู้จัดงาน',
  'photo.region.src': 'ภาพ © องค์การส่งเสริมการท่องเที่ยวเกาหลี PhotoKorea (KOGL ประเภท 1)',
